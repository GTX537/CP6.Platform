...
$versionEntryPoints = @{
    'eng/p10/Pack-P10FormalPackages.ps1' = 'PackageVersion'
    'eng/p10/New-P10FormalPackageSet.ps1' = 'PackageVersion'
    'eng/p10/Publish-P10FormalPackageSet.ps1' = 'PackageVersion'
    'eng/p10/Test-P10FormalPrerequisites.ps1' = 'PackageVersion'
    'eng/p10/Test-P10FormalPackageSet.ps1' = 'ExpectedVersion'
    'eng/p10/New-P10FormalPublicationRecord.ps1' = 'PackageVersion'
}
foreach ($entry in $versionEntryPoints.GetEnumerator()) {
    $reader = $entry.Key -in 'eng/p10/Test-P10FormalPackageSet.ps1', 'eng/p10/New-P10FormalPublicationRecord.ps1'
