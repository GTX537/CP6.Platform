...
- Keep immutable historical packages unchanged. The forward package candidate is `0.10.2`; review, normal branch delivery, protected formal publication, fresh fixed-feed consumption and full C01 cross-repository acceptance remain pending.
