...
| `CP6.Platform.Messaging` | 消息基础设施 | P04：CloudEvents、JSON Schema、bundle 与兼容验证；P05 Candidate：Dapr invocation/PubSub 与 Kafka topic/partition 约定 |
