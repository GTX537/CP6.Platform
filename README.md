...
| `CP6.Platform.Release` | P10 release/evidence/trust schemas、确定性 JSON 与语义验证 | `0.10.0` 正式发布历史保留；`0.10.1` Schema 修复待发布，S05/S06 尚未验收 |
