...
| `CP6.Platform.Release` | P10 release/evidence/trust schemas、确定性 JSON 与语义验证 | 修复后的七包 `0.10.1` 已正式发布并通过两系统复验；S05/S06 尚未验收 |
