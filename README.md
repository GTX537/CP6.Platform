...
| `CP6.Platform.Deployment` | P09 非生产 Profile/Evidence 与 Compose/Kubernetes 资产 | `0.9.0-alpha.1` 已发布并独立验证；`Published / Consumer Candidate` |
