...
| `CP6.Platform.Release` | P10 release/evidence/trust schemas、确定性 JSON 与语义验证 | `0.10.0` test-candidate contract；仅 S00–S02 测试 artifact，不是正式发布 |
