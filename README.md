...
| `CP6.Platform.Deployment` | P09 非生产 Profile/Evidence 与 Compose/Kubernetes 资产 | `0.9.0-alpha.1` candidate；S04 exact-main publisher 已就绪，上传待执行 |
